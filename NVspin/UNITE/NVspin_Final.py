...
fin1.rename(columns={0:"Case", 1:"Used Algorithm", 2:'Theta, Phi', 3: "Target state Projection", 4: "Initial state Projection", 5: "Cost"}, inplace=True)
