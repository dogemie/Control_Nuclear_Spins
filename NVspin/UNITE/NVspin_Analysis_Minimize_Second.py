...
for x in range(count):                                         #반복 횟수 지정
    ...
    for y in range(1):                                      #측정 횟수 지정 같은 작업을 여러번 진행할 경우를 대비하여 반복문 사용
        ...
        if(var1 <= vastand):
            ...
            break
        # result2 = scipy.optimize.minimize(problem,deg,bounds=bounds,method="Nelder-Mead")               #Standard를 넘어가면 Nelder-Mead 최적화
        # deft2 = degree(result2['x'][0], result2['x'][1])
        ...
        #     end = time.time()
        #     final = end - start
        #     output1.append(["Case" + str(x + 1), "Nelder-Mead", result2['x'], final, deft2, car2, idden.data, ideal, deftl2, var2])
        #     break
        ...
        #     break
        result1 = scipy.optimize.minimize(problem1,deg,bounds=bounds,method="Powell")                        #Powell 최적화
        deft1 = degree(result1['x'][0], result1['x'][1])     #최적화된 값으로 density matrix를 생성
        deftl1 = [np.trace(deft1*Sx()),np.trace(deft1*Sy()),np.trace(deft1*Sz())] #최적화된 density matrix의 x,y,z projection을 저장
        car1 = ((idden.data[0, 0] - deft1[0, 0])**2 + (idden.data[0, 1] - deft1[0, 1])**2 + (idden.data[1, 1] - deft1[1, 1])**2)**(1/2) #최적화 정도 측정
        var1 = ((ideal[0] - deftl1[0])**2 + (ideal[1] - deftl1[1])**2 + (ideal[2] - deftl1[2])**2)**(1/2)
        if(var1 <= vastand):
            ...
            break
        # result2 = scipy.optimize.minimize(problem1,deg,bounds=bounds,method="Nelder-Mead")               #Standard를 넘어가면 Nelder-Mead 최적화
        # deft2 = degree(result2['x'][0], result2['x'][1])
        # deftl2 = [np.trace(deft2*Sx()),np.trace(deft2*Sy()),np.trace(deft2*Sz())] #최적화된 density matrix의 x,y,z projection을 저장
        # var2 = ((ideal[0] - deftl2[0])**2 + (ideal[1] - deftl2[1])**2 + (ideal[2] - deftl2[2])**2)**(1/2)
        # car2 = ((idden.data[0, 0] - deft2[0, 0])**2 + (idden.data[0, 1] - deft2[0, 1])**2 + (idden.data[1, 1] - deft2[1, 1])**2)**(1/2)
        ...
        #     end = time.time()
        #     final = end - start
        #     output1.append(["Case" + str(x + 1), "Nelder-Mead1", result2['x'], final, deft2, car2, idden.data, ideal, deftl2, var2])
        #     break
        # result3 = scipy.optimize.differential_evolution(problem1, bounds=bounds)      #Standard를 넘어가면 differential_evolution 최적화
        # deft3 = degree(result3['x'][0], result3['x'][1])
        # deftl3 = [np.trace(deft3*Sx()),np.trace(deft3*Sy()),np.trace(deft3*Sz())] #최적화된 density matrix의 x,y,z projection을 저장
        # var3 = ((ideal[0] - deftl3[0])**2 + (ideal[1] - deftl3[1])**2 + (ideal[2] - deftl3[2])**2)**(1/2)
        # car3 = ((idden.data[0, 0] - deft3[0, 0])**2 + (idden.data[0, 1] - deft3[0, 1])**2 + (idden.data[1, 1] - deft3[1, 1])**2)**(1/2)
        ...
        #     end = time.time()
        #     final = end - start
        #     output1.append(["Case" + str(x + 1), "differential_evolution1", result3['x'], final, deft3, car3, idden.data, ideal, deftl3, var3])
        #     break
        result1 = scipy.optimize.minimize(problem2,deg,bounds=bounds,method="Powell")                        #Powell 최적화
        deft1 = degree(result1['x'][0], result1['x'][1])     #최적화된 값으로 density matrix를 생성
        deftl1 = [np.trace(deft1*Sx()),np.trace(deft1*Sy()),np.trace(deft1*Sz())] #최적화된 density matrix의 x,y,z projection을 저장
        car1 = ((idden.data[0, 0] - deft1[0, 0])**2 + (idden.data[0, 1] - deft1[0, 1])**2 + (idden.data[1, 1] - deft1[1, 1])**2)**(1/2) #최적화 정도 측정
        var1 = ((ideal[0] - deftl1[0])**2 + (ideal[1] - deftl1[1])**2 + (ideal[2] - deftl1[2])**2)**(1/2)
        if(var1 <= vastand):
            ...
            final = end - start                             #시간 측정 종료
            output1.append(["Case" + str(x + 1), "Powell2", result1['x'], final, deft1, car1, idden.data, ideal, deftl1, var1])                             #측정 값 저장
            break
        # result2 = scipy.optimize.minimize(problem2,deg,bounds=bounds,method="Nelder-Mead")               #Standard를 넘어가면 Nelder-Mead 최적화
        # deft2 = degree(result2['x'][0], result2['x'][1])
        # deftl2 = [np.trace(deft2*Sx()),np.trace(deft2*Sy()),np.trace(deft2*Sz())] #최적화된 density matrix의 x,y,z projection을 저장
        # var2 = ((ideal[0] - deftl2[0])**2 + (ideal[1] - deftl2[1])**2 + (ideal[2] - deftl2[2])**2)**(1/2)
        # car2 = ((idden.data[0, 0] - deft2[0, 0])**2 + (idden.data[0, 1] - deft2[0, 1])**2 + (idden.data[1, 1] - deft2[1, 1])**2)**(1/2)
        ...
        #     end = time.time()
        #     final = end - start
        #     output1.append(["Case" + str(x + 1), "Nelder-Mead2", result2['x'], final, deft2, car2, idden.data, ideal, deftl2, var2])
        #     break
        # result3 = scipy.optimize.differential_evolution(problem2, bounds=bounds)      #Standard를 넘어가면 differential_evolution 최적화
        # deft3 = degree(result3['x'][0], result3['x'][1])
        # deftl3 = [np.trace(deft3*Sx()),np.trace(deft3*Sy()),np.trace(deft3*Sz())] #최적화된 density matrix의 x,y,z projection을 저장
        # var3 = ((ideal[0] - deftl3[0])**2 + (ideal[1] - deftl3[1])**2 + (ideal[2] - deftl3[2])**2)**(1/2)
        # car3 = ((idden.data[0, 0] - deft3[0, 0])**2 + (idden.data[0, 1] - deft3[0, 1])**2 + (idden.data[1, 1] - deft3[1, 1])**2)**(1/2)
        ...
        #     end = time.time()
        #     final = end - start
        #     output1.append(["Case" + str(x + 1), "differential_evolution2", result3['x'], final, deft3, car3, idden.data, ideal, deftl3, var3])
        #     break
        result1 = scipy.optimize.minimize(problem3,deg,bounds=bounds,method="Powell")                        #Powell 최적화
        deft1 = degree(result1['x'][0], result1['x'][1])     #최적화된 값으로 density matrix를 생성
        deftl1 = [np.trace(deft1*Sx()),np.trace(deft1*Sy()),np.trace(deft1*Sz())] #최적화된 density matrix의 x,y,z projection을 저장
        car1 = ((idden.data[0, 0] - deft1[0, 0])**2 + (idden.data[0, 1] - deft1[0, 1])**2 + (idden.data[1, 1] - deft1[1, 1])**2)**(1/2) #최적화 정도 측정
        var1 = ((ideal[0] - deftl1[0])**2 + (ideal[1] - deftl1[1])**2 + (ideal[2] - deftl1[2])**2)**(1/2)
        if(var1 <= vastand):
            ...
            final = end - start                             #시간 측정 종료
            output1.append(["Case" + str(x + 1), "Powell3", result1['x'], final, deft1, car1, idden.data, ideal, deftl1, var1])                             #측정 값 저장
            break
        # result2 = scipy.optimize.minimize(problem3,deg,bounds=bounds,method="Nelder-Mead")               #Standard를 넘어가면 Nelder-Mead 최적화
        # deft2 = degree(result2['x'][0], result2['x'][1])
        # deftl2 = [np.trace(deft2*Sx()),np.trace(deft2*Sy()),np.trace(deft2*Sz())] #최적화된 density matrix의 x,y,z projection을 저장
        # var2 = ((ideal[0] - deftl2[0])**2 + (ideal[1] - deftl2[1])**2 + (ideal[2] - deftl2[2])**2)**(1/2)
        # car2 = ((idden.data[0, 0] - deft2[0, 0])**2 + (idden.data[0, 1] - deft2[0, 1])**2 + (idden.data[1, 1] - deft2[1, 1])**2)**(1/2)
        ...
        #     end = time.time()
        #     final = end - start
        #     output1.append(["Case" + str(x + 1), "Nelder-Mead3", result2['x'], final, deft2, car2, idden.data, ideal, deftl2, var2])
        #     break
        # result3 = scipy.optimize.differential_evolution(problem3, bounds=bounds)      #Standard를 넘어가면 differential_evolution 최적화
        # deft3 = degree(result3['x'][0], result3['x'][1])
        # deftl3 = [np.trace(deft3*Sx()),np.trace(deft3*Sy()),np.trace(deft3*Sz())] #최적화된 density matrix의 x,y,z projection을 저장
        # var3 = ((ideal[0] - deftl3[0])**2 + (ideal[1] - deftl3[1])**2 + (ideal[2] - deftl3[2])**2)**(1/2)
        # car3 = ((idden.data[0, 0] - deft3[0, 0])**2 + (idden.data[0, 1] - deft3[0, 1])**2 + (idden.data[1, 1] - deft3[1, 1])**2)**(1/2)
        ...
        #     end = time.time()
        #     final = end - start
        #     output1.append(["Case" + str(x + 1), "differential_evolution3", result3['x'], final, deft3, car3, idden.data, ideal, deftl3, var3])
        #     break
        # result1 = scipy.optimize.minimize(problem4,deg,bounds=bounds,method="Powell")                        #Powell 최적화
        # deft1 = degree(result1['x'][0], result1['x'][1])     #최적화된 값으로 density matrix를 생성
        # deftl1 = [np.trace(deft1*Sx()),np.trace(deft1*Sy()),np.trace(deft1*Sz())] #최적화된 density matrix의 x,y,z projection을 저장
        # car1 = ((idden.data[0, 0] - deft1[0, 0])**2 + (idden.data[0, 1] - deft1[0, 1])**2 + (idden.data[1, 1] - deft1[1, 1])**2)**(1/2) #최적화 정도 측정
        # var1 = ((ideal[0] - deftl1[0])**2 + (ideal[1] - deftl1[1])**2 + (ideal[2] - deftl1[2])**2)**(1/2)
        ...
        #     end = time.time()
        #     final = end - start                             #시간 측정 종료
        #     output1.append(["Case" + str(x + 1), "Powell4", result1['x'], final, deft1, car1, idden.data, ideal, deftl1, var1])                             #측정 값 저장
        #     break
        # result2 = scipy.optimize.minimize(problem4,deg,bounds=bounds,method="Nelder-Mead")               #Standard를 넘어가면 Nelder-Mead 최적화
        # deft2 = degree(result2['x'][0], result2['x'][1])
        # deftl2 = [np.trace(deft2*Sx()),np.trace(deft2*Sy()),np.trace(deft2*Sz())] #최적화된 density matrix의 x,y,z projection을 저장
        # var2 = ((ideal[0] - deftl2[0])**2 + (ideal[1] - deftl2[1])**2 + (ideal[2] - deftl2[2])**2)**(1/2)
        # car2 = ((idden.data[0, 0] - deft2[0, 0])**2 + (idden.data[0, 1] - deft2[0, 1])**2 + (idden.data[1, 1] - deft2[1, 1])**2)**(1/2)
        ...
        #     end = time.time()
        #     final = end - start
        #     output1.append(["Case" + str(x + 1), "Nelder-Mead4", result2['x'], final, deft2, car2, idden.data, ideal, deftl2, var2])
        #     break
        # result3 = scipy.optimize.differential_evolution(problem4, bounds=bounds)      #Standard를 넘어가면 differential_evolution 최적화
        # deft3 = degree(result3['x'][0], result3['x'][1])
        # deftl3 = [np.trace(deft3*Sx()),np.trace(deft3*Sy()),np.trace(deft3*Sz())] #최적화된 density matrix의 x,y,z projection을 저장
        # var3 = ((ideal[0] - deftl3[0])**2 + (ideal[1] - deftl3[1])**2 + (ideal[2] - deftl3[2])**2)**(1/2)
        # car3 = ((idden.data[0, 0] - deft3[0, 0])**2 + (idden.data[0, 1] - deft3[0, 1])**2 + (idden.data[1, 1] - deft3[1, 1])**2)**(1/2)
        ...
        #     end = time.time()
        #     final = end - start
        #     output1.append(["Case" + str(x + 1), "differential_evolution4", result3['x'], final, deft3, car3, idden.data, ideal, deftl3, var3])
        #     break
        # result1 = scipy.optimize.minimize(problem5,deg,bounds=bounds,method="Powell")                        #Powell 최적화
        # deft1 = degree(result1['x'][0], result1['x'][1])     #최적화된 값으로 density matrix를 생성
        # deftl1 = [np.trace(deft1*Sx()),np.trace(deft1*Sy()),np.trace(deft1*Sz())] #최적화된 density matrix의 x,y,z projection을 저장
        # car1 = ((idden.data[0, 0] - deft1[0, 0])**2 + (idden.data[0, 1] - deft1[0, 1])**2 + (idden.data[1, 1] - deft1[1, 1])**2)**(1/2) #최적화 정도 측정
        # var1 = ((ideal[0] - deftl1[0])**2 + (ideal[1] - deftl1[1])**2 + (ideal[2] - deftl1[2])**2)**(1/2)
        ...
        #     end = time.time()
        #     final = end - start                             #시간 측정 종료
        #     output1.append(["Case" + str(x + 1), "Powell5", result1['x'], final, deft1, car1, idden.data, ideal, deftl1, var1])                             #측정 값 저장
        #     break
        # result2 = scipy.optimize.minimize(problem5,deg,bounds=bounds,method="Nelder-Mead")               #Standard를 넘어가면 Nelder-Mead 최적화
        # deft2 = degree(result2['x'][0], result2['x'][1])
        # deftl2 = [np.trace(deft2*Sx()),np.trace(deft2*Sy()),np.trace(deft2*Sz())] #최적화된 density matrix의 x,y,z projection을 저장
        # var2 = ((ideal[0] - deftl2[0])**2 + (ideal[1] - deftl2[1])**2 + (ideal[2] - deftl2[2])**2)**(1/2)
        # car2 = ((idden.data[0, 0] - deft2[0, 0])**2 + (idden.data[0, 1] - deft2[0, 1])**2 + (idden.data[1, 1] - deft2[1, 1])**2)**(1/2)
        ...
        #     end = time.time()
        #     final = end - start
        #     output1.append(["Case" + str(x + 1), "Nelder-Mead5", result2['x'], final, deft2, car2, idden.data, ideal, deftl2, var2])
        #     break
        # result3 = scipy.optimize.differential_evolution(problem5, bounds=bounds)      #Standard를 넘어가면 differential_evolution 최적화
        # deft3 = degree(result3['x'][0], result3['x'][1])
        # deftl3 = [np.trace(deft3*Sx()),np.trace(deft3*Sy()),np.trace(deft3*Sz())] #최적화된 density matrix의 x,y,z projection을 저장
        # var3 = ((ideal[0] - deftl3[0])**2 + (ideal[1] - deftl3[1])**2 + (ideal[2] - deftl3[2])**2)**(1/2)
        # car3 = ((idden.data[0, 0] - deft3[0, 0])**2 + (idden.data[0, 1] - deft3[0, 1])**2 + (idden.data[1, 1] - deft3[1, 1])**2)**(1/2)
        ...
        #     end = time.time()
        #     final = end - start
        #     output1.append(["Case" + str(x + 1), "differential_evolution5", result3['x'], final, deft3, car3, idden.data, ideal, deftl3, var3])
        #     break
        # result1 = scipy.optimize.minimize(problem6,deg,bounds=bounds,method="Powell")                        #Powell 최적화
        # deft1 = degree(result1['x'][0], result1['x'][1])     #최적화된 값으로 density matrix를 생성
        # deftl1 = [np.trace(deft1*Sx()),np.trace(deft1*Sy()),np.trace(deft1*Sz())] #최적화된 density matrix의 x,y,z projection을 저장
        # car1 = ((idden.data[0, 0] - deft1[0, 0])**2 + (idden.data[0, 1] - deft1[0, 1])**2 + (idden.data[1, 1] - deft1[1, 1])**2)**(1/2) #최적화 정도 측정
        # var1 = ((ideal[0] - deftl1[0])**2 + (ideal[1] - deftl1[1])**2 + (ideal[2] - deftl1[2])**2)**(1/2)
        ...
        #     end = time.time()
        #     final = end - start                             #시간 측정 종료
        #     output1.append(["Case" + str(x + 1), "Powell6", result1['x'], final, deft1, car1, idden.data, ideal, deftl1, var1])                             #측정 값 저장
        #     break
        # result2 = scipy.optimize.minimize(problem6,deg,bounds=bounds,method="Nelder-Mead")               #Standard를 넘어가면 Nelder-Mead 최적화
        # deft2 = degree(result2['x'][0], result2['x'][1])
        # deftl2 = [np.trace(deft2*Sx()),np.trace(deft2*Sy()),np.trace(deft2*Sz())] #최적화된 density matrix의 x,y,z projection을 저장
        # var2 = ((ideal[0] - deftl2[0])**2 + (ideal[1] - deftl2[1])**2 + (ideal[2] - deftl2[2])**2)**(1/2)
        # car2 = ((idden.data[0, 0] - deft2[0, 0])**2 + (idden.data[0, 1] - deft2[0, 1])**2 + (idden.data[1, 1] - deft2[1, 1])**2)**(1/2)
        ...
        #     end = time.time()
        #     final = end - start
        #     output1.append(["Case" + str(x + 1), "Nelder-Mead6", result2['x'], final, deft2, car2, idden.data, ideal, deftl2, var2])
        #     break
        # result3 = scipy.optimize.differential_evolution(problem6, bounds=bounds)      #Standard를 넘어가면 differential_evolution 최적화
        # deft3 = degree(result3['x'][0], result3['x'][1])
        # deftl3 = [np.trace(deft3*Sx()),np.trace(deft3*Sy()),np.trace(deft3*Sz())] #최적화된 density matrix의 x,y,z projection을 저장
        # var3 = ((ideal[0] - deftl3[0])**2 + (ideal[1] - deftl3[1])**2 + (ideal[2] - deftl3[2])**2)**(1/2)
        # car3 = ((idden.data[0, 0] - deft3[0, 0])**2 + (idden.data[0, 1] - deft3[0, 1])**2 + (idden.data[1, 1] - deft3[1, 1])**2)**(1/2)
        ...
        #     end = time.time()
        #     final = end - start
        #     output1.append(["Case" + str(x + 1), "differential_evolution6", result3['x'], final, deft3, car3, idden.data, ideal, deftl3, var3])
        #     break
        result1 = scipy.optimize.minimize(problem7,deg,bounds=bounds,method="Powell")                        #Powell 최적화
        deft1 = degree(result1['x'][0], result1['x'][1])     #최적화된 값으로 density matrix를 생성
        deftl1 = [np.trace(deft1*Sx()),np.trace(deft1*Sy()),np.trace(deft1*Sz())] #최적화된 density matrix의 x,y,z projection을 저장
        car1 = ((idden.data[0, 0] - deft1[0, 0])**2 + (idden.data[0, 1] - deft1[0, 1])**2 + (idden.data[1, 1] - deft1[1, 1])**2)**(1/2) #최적화 정도 측정
        var1 = ((ideal[0] - deftl1[0])**2 + (ideal[1] - deftl1[1])**2 + (ideal[2] - deftl1[2])**2)**(1/2)
        if(var1 <= vastand):
            ...
            final = end - start                             #시간 측정 종료
            output1.append(["Case" + str(x + 1), "Powell7", result1['x'], final, deft1, car1, idden.data, ideal, deftl1, var1])                             #측정 값 저장
            break
        # result2 = scipy.optimize.minimize(problem7,deg,bounds=bounds,method="Nelder-Mead")               #Standard를 넘어가면 Nelder-Mead 최적화
        # deft2 = degree(result2['x'][0], result2['x'][1])
        # deftl2 = [np.trace(deft2*Sx()),np.trace(deft2*Sy()),np.trace(deft2*Sz())] #최적화된 density matrix의 x,y,z projection을 저장
        # var2 = ((ideal[0] - deftl2[0])**2 + (ideal[1] - deftl2[1])**2 + (ideal[2] - deftl2[2])**2)**(1/2)
        # car2 = ((idden.data[0, 0] - deft2[0, 0])**2 + (idden.data[0, 1] - deft2[0, 1])**2 + (idden.data[1, 1] - deft2[1, 1])**2)**(1/2)
        ...
        #     end = time.time()
        #     final = end - start
        #     output1.append(["Case" + str(x + 1), "Nelder-Mead7", result2['x'], final, deft2, car2, idden.data, ideal, deftl2, var2])
        #     break
        # result3 = scipy.optimize.differential_evolution(problem7, bounds=bounds)      #Standard를 넘어가면 differential_evolution 최적화
        # deft3 = degree(result3['x'][0], result3['x'][1])
        # deftl3 = [np.trace(deft3*Sx()),np.trace(deft3*Sy()),np.trace(deft3*Sz())] #최적화된 density matrix의 x,y,z projection을 저장
        # var3 = ((ideal[0] - deftl3[0])**2 + (ideal[1] - deftl3[1])**2 + (ideal[2] - deftl3[2])**2)**(1/2)
        # car3 = ((idden.data[0, 0] - deft3[0, 0])**2 + (idden.data[0, 1] - deft3[0, 1])**2 + (idden.data[1, 1] - deft3[1, 1])**2)**(1/2)
        ...
        #     end = time.time()
        #     final = end - start
        #     output1.append(["Case" + str(x + 1), "differential_evolution7", result3['x'], final, deft3, car3, idden.data, ideal, deftl3, var3])
        #     break
        end = time.time()
        final = end - start
        output1.append(["Case" + str(x + 1), "None", result1['x'], final, deft1, car1, idden.data, ideal, deftl1, var1])
        fail = fail + 1
...
print("Fail : " + str(fail) + "/" + str(count))                                                #측정 실패한 경우 출력
