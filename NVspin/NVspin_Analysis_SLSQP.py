...
while true:
    result = scipy.optimize.minimize(problem,deg,bounds=bounds,method='SLSQP',options={'eps': xx,'ftol': ff})
    output.append(result)
...
print(date)
fin.to_csv("C:/Users/Administrator/2023.01.01/KIST_intern/Task1/Control_Nuclear_Spins/NVspin/SLSQP/SLSQP_result_" + printdate + '.csv', index=false)
