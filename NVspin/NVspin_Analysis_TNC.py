...
while true:
    result = scipy.optimize.minimize(problem,deg,bounds=bounds,method='TNC',options={'xtol': xx,'ftol': ff})
    output.append(result)
...
print(date)
fin.to_csv("C:/Users/Administrator/2023.01.01/KIST_intern/Task1/Control_Nuclear_Spins/NVspin/TNC/TNC_result_" + printdate + '.csv', index=false)
