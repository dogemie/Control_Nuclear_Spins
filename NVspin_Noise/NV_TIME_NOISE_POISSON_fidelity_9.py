...
for x in range(count):                                       #반복 횟수 지정
    ...
    tempTheta = 0
    tempPhi = 0
    mu, sigma = 0, 0.7 # mean and standard deviation of the normal distribution
    ...
    output1.append(["Case" + str(x + 1) + "Fin", result['x'][0], result['x'][1], trace_time[0], ideal[0], ideal[1], ideal[2], deftl1[0], deftl1[1], deftl1[2], noisy[0], noisy[1], noisy[2], temx , temy, temz, err , temTh, temPh, cost]) 
