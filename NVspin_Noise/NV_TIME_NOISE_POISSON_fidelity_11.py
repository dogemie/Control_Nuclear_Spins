...
for zz in range(1, 10):
    ...
    fin1.to_csv("C:/Users/Administrator/Dogyeom(2023.01.01)/KIST_intern/Task1/Control_Nuclear_Spins/NVspin_Noise/sigma/Result_" + str(round(zz * 0.1, 1)) + "_" + printdate + '.csv', index=false)
