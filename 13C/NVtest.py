...
for x in tqdm(range(count)):                                         #반복 횟수 지정
    ...
    for y in range(0, seccount):                                #측정 횟수 지정 같은 작업을 여러번 진행할 경우를 대비하여 반복문 사용
        ...
        if var1 < vastand:                                      #최적화 정도가 기준보다 작을 경우
            ...
            output1.append([result1['x'][0], result1['x'][1], dat[0][0].real, dat[0][0].imag, dat[0][1].real, dat[0][1].imag, dat[1][0].real, dat[1][0].imag, dat[1][1].real, dat[1][1].imag])                                #측정 값 저장
            success = success + 1
            break
...
fin1.rename(columns={0: 'Theta', 1: 'Phi', 2: '00R', 3: '00I', 4: '01R', 5: '01I', 6: '10R', 7: '10I', 8: '11R', 9: '11I'}, inplace=True)
...
fin1.to_csv('C:/Users/KIST3/Desktop/NVDT/Result_' + printdate + '.csv', index=false)
